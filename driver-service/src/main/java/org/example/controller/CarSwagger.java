...
public interface CarSwagger {
    ...
    PagedResponse<CarResponse> getAllCars(@RequestParam(defaultValue = "0") @Min(value = 0, message = "page.incorrect") int page,
    ...
    SuccessResponse registerCar(@Valid @RequestBody CarRequest carRequest);
